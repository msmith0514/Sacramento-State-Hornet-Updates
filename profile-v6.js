...
if (!player) {
  ...
  const img=$('profilePhoto'); img.src=player.profileImage; img.alt=`${player.name} profile photo`; img.onerror=()=>{img.style.display='none';$('profileInitials').style.display='grid';};
